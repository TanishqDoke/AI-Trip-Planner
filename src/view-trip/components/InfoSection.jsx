    ...
    if (!trip || !trip.userSelection) {
        return (
            <div className='bg-white rounded-lg border-2 border-gray-200 shadow-md overflow-hidden'>
                <div className='relative h-64 md:h-80 bg-gray-200 animate-pulse'></div>
                <div className='p-8'>
                    <div className='mb-6'>
            ...
            <div className='relative h-64 md:h-80'>
                {isLoading ? (
                    <div className="w-full h-full bg-gray-100 flex items-center justify-center">
                        <div className='w-8 h-8 border-4 border-[#2276E3] border-t-transparent rounded-full animate-spin'></div>
                    </div>
                ) : (
                    <img
                        src={photoUrl}
            ...
            <div className='p-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
                    ...
                    <div className='flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100'>
                        ...
                        <div>
                            <p className='text-xs text-gray-600 font-medium'>Recommended Hotel</p>
                    ...
                    <div className='flex items-center gap-3 p-4 bg-red-50 rounded-lg border border-red-100'>
                        ...
                        <div>
                            ...
                            <p className='font-bold text-gray-900 text-sm capitalize'>{trip?.userSelection?.budget || 'N/A'}</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center gap-3 p-4 bg-orange-50 rounded-lg border border-orange-100'>
                        ...
                        <div>
                            <p className='text-xs text-gray-600 font-medium'>Group Size</p>
                            <p className='font-bold text-gray-900 text-sm'>{trip?.userSelection?.traveler || 'N/A'}</p>
                        </div>
                    </div>
                </div>
            </div>
